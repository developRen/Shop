//
//  LFFPraiseButton.swift
//  LFFPraiseButton
//
//  Created by linphone on 2019/8/15.
//  Copyright © 2019 linphone. All rights reserved.
//
...
open class LFFPraiseButton: UIButton{
...
//            line.transform = CATransform3DMakeRotation(CGFloat(M_PI) / 5 * (CGFloat(i) * 2 + 1), 0.0, 0.0, 1.0)
    ...
    @objc func touchDown(_ sender: LFFPraiseButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: LFFPraiseButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: LFFPraiseButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: LFFPraiseButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: LFFPraiseButton) {
        self.layer.opacity = 1.0
    }
